...
def get_args():
    ...
    parser.add_argument(
        ...
        default=600,
        metavar="SIGMA",
        help=r"noise level (number of samples): \sigma = 3 \times \sigma_s (default: 600)",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="MODEL_NAME",
        help="model name: 'seist' or 'lnrl' (default: lnrl)",
    )
    parser.add_argument(
        "--checkpoint",
        default="",
    ...
    parser.add_argument(
        "--data",
        default="/root/data/Datasets/SOS/all",
        metavar="DATA",
        type=str,
    ...
    parser.add_argument(
        ...
        help="name of dataset ('sos' / ...) (default: 'sos')",
    )
    parser.add_argument(
        "--data-split",
        type=bool_,
    ...
    parser.add_argument(
        ...
        type=int,
        metavar="IN_SAMPLES",
        help="the length of input data (default: 6000)",
    )
    parser.add_argument(
        "--label-width",
        type=float,
        default=0.1,
        metavar="LABEL_WIDTH",
        help="width of soft-label (in seconds) (default:0.1)",
    )
    parser.add_argument(
        "--label-shape",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="NORM_MODE",
        help="mode of normalization ('max','rmse' or '') (default: 'rmse')",
    )
    parser.add_argument(
        "--min-snr",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        metavar="BATCH_SIZE",
        help="batch size (default: 300), this is the batch size of each worker (process)",
    )
    parser.add_argument(
        "--optim",
        default="Adam",
    ...
    parser.add_argument(
        ...
        help="Residual threshold (in seconds) (default: 0.05)",
    )
    parser.add_argument(
        "--min-peak-dist",
        default=1.0,
